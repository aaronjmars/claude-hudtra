...
export declare function cost(text: string, colors?: Partial<HudColorOverrides>): string;
export declare function getCostColor(dollars: number, colors?: Partial<HudColorOverrides>): string;
